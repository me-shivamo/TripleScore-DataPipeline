...
![Graph showing the region bounded by the line y = x/2 and the curve y = 4√x in the first quadrant. The region is shaded and bounded by the y-axis, the line y = x/2, and the curve y = 4√x. The intersection point is labeled (64, 32). The origin is labeled (0,0). The x-axis has a tick mark at 2.](images/c7df38125cb41e915adc1787b6c3390a_img.jpg)
...
![Diagram showing an ellipse E centered at the origin (0,0) with vertices at (-a,0) and (a,0) on the x-axis and (0,b) on the y-axis. A circle C is tangent to the ellipse at (0,b) and passes through (-a,0) and (a,0). A triangle PQR is inscribed in the circle, with vertex P on the circle, and side QR parallel to the x-axis. The side QR contains the point (0,b).](images/6a412ce0ee3ac6bd290d214edd54c1da_img.jpg)
...
![Diagram showing a parabola y^2 = 8x opening to the right and a circle x^2 + y^2 + 12y + 35 = 0 centered at (0, -6) with radius 1. A normal line is drawn from the parabola to the circle, passing through the center of the circle. The point of tangency on the parabola is labeled P, and the point of tangency on the circle is labeled Q.](images/802015eeee3d7df8a381390db765c098_img.jpg)
...
![A diagram showing a line segment PQ. Point P is at (7, 10, 11) and point Q is at (3, 4, -1). The line segment is parallel to a line with direction ratios (x-4)/1 = (y-4)/0 = (z-2)/3 = lambda.](images/73c3e4508cae529acf4e6c7fa70b361a_img.jpg)
...
$$\therefore \vec{a} \cdot \vec{d} = 4 \Rightarrow \lambda = -2$$
...
![A diagram of a hyperbola opening horizontally. The center is labeled C(6,2). The vertices are labeled S'(4,2) and S(8,2). A point Q is marked on the lower branch of the hyperbola. The hyperbola is centered at (6,2) with vertices at (4,2) and (8,2).](images/26c8a50517bc00b6cbfe94f46fbc7c08_img.jpg)

A diagram of a hyperbola opening horizontally. The center is labeled C(6,2). The vertices are labeled S'(4,2) and S(8,2). A point Q is marked on the lower branch of the hyperbola. The hyperbola is centered at (6,2) with vertices at (4,2) and (8,2).
...
![A P-V diagram showing a cyclic process. The vertical axis is Pressure (P) and the horizontal axis is Volume (V). The cycle starts at (V0, P0), goes isothermally to (4V0, P0/4) along a curve labeled omega_1. Then it goes isobarically back to (V0, P0/4) along a horizontal line labeled omega_2. Finally, it goes isochorically back to (V0, P0) along a vertical line labeled omega_3.](images/f519a5be118c846f631c992412353fb9_img.jpg)

Sol.

A P-V diagram showing a cyclic process. The vertical axis is Pressure (P) and the horizontal axis is Volume (V). The cycle starts at (V0, P0), goes isothermally to (4V0, P0/4) along a curve labeled omega\_1. Then it goes isobarically back to (V0, P0/4) along a horizontal line labeled omega\_2. Finally, it goes isochorically back to (V0, P0) along a vertical line labeled omega\_3.
...
![A circuit diagram showing two capacitors in parallel. The top capacitor is labeled +C0V0 and the bottom capacitor is labeled -C0V0. A switch is connected in series with the capacitors. The bottom capacitor is also labeled with a 'C'.](images/eb908b4a1fe2754bb89d35989ef4d218_img.jpg)

Sol.

A circuit diagram showing two capacitors in parallel. The top capacitor is labeled +C0V0 and the bottom capacitor is labeled -C0V0. A switch is connected in series with the capacitors. The bottom capacitor is also labeled with a 'C'.
...
Sol.  $v_T \Rightarrow \frac{2 (\rho_0 - \rho_t) r^2 g}{9 \eta}$
...
![Logic circuit diagram showing an OR gate with inputs A and B, and its output connected to one input of an AND gate. The other input of the AND gate is connected to input A. The output of the AND gate is labeled C.](images/007b053fe94a8348f75128a584503fd0_img.jpg)

Logic circuit diagram showing an OR gate with inputs A and B, and its output connected to one input of an AND gate. The other input of the AND gate is connected to input A. The output of the AND gate is labeled C.
...
![Logic circuit diagram for problem 39. It shows an OR gate with inputs A and B, and its output labeled A+B. This output is connected to one input of an AND gate. The other input of the AND gate is connected to input A. The output of the AND gate is labeled C = A · (A + B).](images/78ffccd66df9bafd96e3e081110d09dd_img.jpg)

Logic circuit diagram for problem 39. It shows an OR gate with inputs A and B, and its output labeled A+B. This output is connected to one input of an AND gate. The other input of the AND gate is connected to input A. The output of the AND gate is labeled C = A · (A + B).
...
![Circuit diagram for series connection. A 1V cell with 2 ohm internal resistance and a 2V cell with 1 ohm internal resistance are connected in series with a 6 ohm external resistor.](images/16c1175b5f05a4b55e6d396fc51b15b3_img.jpg)

Sol.

Circuit diagram for series connection. A 1V cell with 2 ohm internal resistance and a 2V cell with 1 ohm internal resistance are connected in series with a 6 ohm external resistor.
...
![Circuit diagram for parallel connection. A 1V cell with 2 ohm internal resistance and a 2V cell with 1 ohm internal resistance are connected in parallel, and this combination is connected to a 6 ohm external resistor.](images/704082cc3e11776bda29595c76411362_img.jpg)

Circuit diagram for parallel connection. A 1V cell with 2 ohm internal resistance and a 2V cell with 1 ohm internal resistance are connected in parallel, and this combination is connected to a 6 ohm external resistor.
...
![A conductometric titration graph showing Conductance (mS) on the y-axis versus V_NaOH/mL on the x-axis. The curve starts at point A, decreases linearly to point B at 2.0 mL, then increases slightly to point C at 5.0 mL, and finally increases sharply to point D. The x-axis has tick marks at 2.0 and 5.0 mL.](images/fe753d01ad5fe6cf150018c958173c6d_img.jpg)

A conductometric titration graph showing Conductance (mS) on the y-axis versus V\_NaOH/mL on the x-axis. The curve starts at point A, decreases linearly to point B at 2.0 mL, then increases slightly to point C at 5.0 mL, and finally increases sharply to point D. The x-axis has tick marks at 2.0 and 5.0 mL.
...
![](images/990a93e637a03ad92255619ed6093f35_img.jpg)

$$\text{NaOH} + \text{HCl} \rightarrow \text{NaCl} + \text{H}_2\text{O}$$

$$\text{Initial : MV} = 2 \times 0.1 \quad \text{MV} = 1 \times 0.2$$

$$= 0.2 \text{ mole} \quad = 0.2 \text{ mole}$$

$$\text{Final} \quad 0 \quad 0$$
...
| <b>LIST-I</b><br>(Family) |                        | <b>LIST-II</b><br>(Symbol of Element) |    |
|---------------------------|------------------------|---------------------------------------|----|
| A.                        | Pnicogen<br>(group 15) | I.                                    | Ts |
| B.                        | Chalcogen              | II.                                   | Og |
| C.                        | Halogen                | III.                                  | Lv |
| D.                        | Noble gas              | IV.                                   | Mc |
...
![](images/5c474a84cc7920bf876a34204666eed4_img.jpg)

**Sol.**

$$\text{Ph}-\underset{\text{O}}{\underset{\parallel}{\text{C}}}-\underset{\text{O}}{\underset{\parallel}{\text{C}}}-\text{H} \xrightleftharpoons{\text{KOH}} \text{Ph}-\underset{\text{O}}{\underset{\parallel}{\text{C}}}-\underset{\text{OH}}{\underset{|}{\text{CH}}}-\text{O}^- \text{K}^+ \xrightarrow{\text{rds}} \text{Ph}-\underset{\text{OH}}{\underset{|}{\text{CH}}}-\text{COO}^- \text{K}^+$$

The mechanism shows the nucleophilic attack of hydroxide ion on the carbonyl carbon of benzaldehyde, followed by the rate-determining step (rds) involving hydride transfer to the second carbonyl carbon, resulting in the formation of benzoate ion and methanol.

58. In the following series of reactions identify the major products A & B respectively.

![](images/cf334d7fd57eb391ce64895fc50a4270_img.jpg)

Brc1ccccc1  $\xrightarrow[\text{H}_2\text{SO}_4]{\text{SO}_3}$  A Major product  $\xrightarrow{\text{Br}_2, \text{Fe}}$  B Major product

![](images/6703b55796811c3389650d3f052b27d8_img.jpg)

(1) Brc1ccc(S(=O)(=O)(O)O)cc1 A Brc1ccc(Br)c(S(=O)(=O)(O)O)c1 B  
 (2) Brc1ccc(S(=O)(=O)(O)O)cc1 A Brc1ccc(Br)c(S(=O)(=O)(O)O)c1 B  
 (3) Brc1ccc(S(=O)(=O)(O)O)cc1 A Brc1ccc(S(=O)(=O)(O)O)c(Br)c1 B  
 (4) Brc1ccc(S(=O)(=O)(O)O)cc1 A Brc1ccc(Br)c(S(=O)(=O)(O)O)c1 B

Ans. (2)

![](images/31e33ef91895717f4eb7d5008cf49f0e_img.jpg)

Sol. Brc1ccccc1  $\xrightarrow[\text{H}_2\text{SO}_4]{\text{SO}_3}$  Brc1ccc(S(=O)(=O)(O)O)cc1 Major (A)  $\xrightarrow{\text{Br}_2, \text{Fe}}$  Brc1ccc(Br)c(S(=O)(=O)(O)O)c1 (B)

Both reactions are electrophilic substitution reaction, I<sup>st</sup> is sulphonation and II<sup>nd</sup> is halogenation :
...
![](images/c7462b3b5c960e27fd9615f83323a0a6_img.jpg)

Sol. (A)  $[\text{Mn}(\text{CN})_6]^{3-}$

![](images/c294d45e63fc2c7dcdfb9d9d73dd0c39_img.jpg)

$\text{Mn}^{+3} = (\text{Ar})_{18}$   
 $\Delta_o > P$  Paramagnetic  
 $\begin{array}{c} \square \square \square \square \square \square \square \square \square \square \\ \uparrow \downarrow \uparrow \downarrow \uparrow \downarrow \uparrow \downarrow \uparrow \uparrow \\ t_{2g}^6 e_g^2 \end{array}$

![](images/890599fa2c426fbfea333fae9f0fc7c3_img.jpg)

(B)  $[\text{Co}(\text{NH}_3)_6]^{3+}$

![](images/09ad2f48f6c0310e80a8b3e858f5816a_img.jpg)

$\text{Co}^{+3} = (\text{Ar})_{18}$   
 $\Delta_o > P$  Diamagnetic  
 $\begin{array}{c} \square \square \square \square \square \square \square \square \square \square \\ \uparrow \downarrow \uparrow \downarrow \uparrow \downarrow \uparrow \downarrow \uparrow \downarrow \\ t_{2g}^6 e_g^0 \end{array}$

![](images/f614d3a0cd571233a3f98fa379ed2854_img.jpg)

(C)  $[\text{Fe}(\text{CN})_6]^{4-}$

![](images/c9473c3c2461db0431357a5c7a578a09_img.jpg)

$\text{Fe}^{+2} = (\text{Ar})_{18}$   
 $\Delta_o > P$  Diamagnetic  
 $\begin{array}{c} \square \square \square \square \square \square \square \square \square \square \\ \uparrow \downarrow \uparrow \downarrow \uparrow \downarrow \uparrow \downarrow \uparrow \downarrow \\ t_{2g}^6 e_g^0 \end{array}$

![](images/4b35b8cc3ec598f88e193d5829798976_img.jpg)

(D)  $[\text{Co}(\text{H}_2\text{O})_3\text{F}_3]$

![](images/5e77e8cdad7407e633422756aa631943_img.jpg)

$\text{Co}^{+3} = (\text{Ar})_{18}$   
 $\Delta_o < P$  Paramagnetic  
 $\begin{array}{c} \square \square \square \square \square \square \square \square \square \square \\ \uparrow \downarrow \uparrow \downarrow \uparrow \downarrow \uparrow \uparrow \uparrow \uparrow \\ t_{2g}^4 e_g^2 \end{array}$
...
Given : Molar mass of Mg is 24 g mol<sup>-1</sup>.
...
![](images/2d963be51279f5ac1461051ca82cc878_img.jpg)
...
**Statement I :** CrO<sub>3</sub> is a stronger oxidizing agent than MoO<sub>3</sub>
...
Hence, CrO<sub>3</sub> easily reduce into Cr<sup>+3</sup> as compared to MoO<sub>3</sub> and show stronger oxidizing nature.
...
![Nitrobenzene structure](images/6e74f77e7f44d1836accc11a6c5d5a17_img.jpg)

(1)  $\xrightarrow[\text{(ii) Sn, HCl}]{\text{(i) Br}_2, \text{ acetic}}$

Nitrobenzene structure

![Benzene structure](images/571868053b52bee26cacbfd59c442851_img.jpg)

(2)  $\xrightarrow[\text{(ii) NH}_3]{\text{(i) Br}_2, \text{ AlBr}_3}$

Benzene structure

![Aniline structure](images/8626cfffd21acccd972b7020824bb1fa_img.jpg)

(3)  $\xrightarrow[\text{(ii) NaNO}_2, \text{ HCl, CuBr}]{\text{(i) Br}_2(\text{excess}), \text{ acetic acid}}$

Aniline structure

![Aniline structure](images/a835622e236456dbf53bec73c71e9174_img.jpg)
...
![Reaction scheme for the synthesis of 3,4,5-tribromoaniline from aniline. Aniline reacts with excess Br2 in acetic acid to form 3,5-dibromoaniline. This is then treated with NaNO2 and HCl to form the diazonium salt (3,5-dibromobenzenediazonium chloride). This salt undergoes a Sandmeyer reaction with CuBr to form 3,5-dibromobenzene. Finally, 3,5-dibromobenzene is reduced with Sn + HCl to form 3,5-dibromoaniline.](images/7a8c40a0f544794befa404a7d4ca2c9b_img.jpg)

3,4,5-tri bromo aniline

Reaction scheme for the synthesis of 3,4,5-tribromoaniline from aniline. Aniline reacts with excess Br2 in acetic acid to form 3,5-dibromoaniline. This is then treated with NaNO2 and HCl to form the diazonium salt (3,5-dibromobenzenediazonium chloride). This salt undergoes a Sandmeyer reaction with CuBr to form 3,5-dibromobenzene. Finally, 3,5-dibromobenzene is reduced with Sn + HCl to form 3,5-dibromoaniline.
...
| Density (g/cm <sup>3</sup> ) | 2.35 | 2.7 | 5.9 | 7.31 | 11.85 |
...
IE<sub>1</sub> Order  $B > Tl > Ga > Al > In$

69. What is the correct IUPAC name of

![Chemical structure of 3-bromo-2-hydroxy-5-nitrobenzoic acid. A benzene ring has a CO2H group at position 1, an OH group at position 2, a Br atom at position 3, and an O2N group at position 5. A question mark is placed near the ring.](images/3bb9ec1ae84a93977f728fc08e61b4a3_img.jpg)

Chemical structure of 3-bromo-2-hydroxy-5-nitrobenzoic acid. A benzene ring has a CO2H group at position 1, an OH group at position 2, a Br atom at position 3, and an O2N group at position 5. A question mark is placed near the ring.
...
![Numbered chemical structure of 3-bromo-2-hydroxy-5-nitrobenzoic acid. The benzene ring is numbered 1 to 6 starting from the CO2H group. CO2H is at 1, OH is at 2, Br is at 3, and O2N is at 5.](images/b29317f7467d9759a3cea1e5ab989474_img.jpg)

Sol.

Numbered chemical structure of 3-bromo-2-hydroxy-5-nitrobenzoic acid. The benzene ring is numbered 1 to 6 starting from the CO2H group. CO2H is at 1, OH is at 2, Br is at 3, and O2N is at 5.
...
[Given : molar mass (in g mol<sup>-1</sup>) C : 12, H : 1, O : 16, N : 14]

Ans. (3)

![Chemical reaction showing nitrobenzene (a benzene ring with an NO2 group) undergoing nitration (indicated by an arrow with 'Nitration' and a delta symbol) to form m-dinitrobenzene (a benzene ring with two NO2 groups at positions 1 and 3). The product is labeled as 4.2 gm.](images/3cdf67a5b6c2eaeeb720b0aded2debc0_img.jpg)
...
![](images/ecacad7edca695d309d9bb8280bd4024_img.jpg)
...
![](images/d0ed771dc1a4eeb983ebd866eabb9f82_img.jpg)

$$\text{Co}^{+2} = (\text{Ar})3d^7$$

![](images/6e74268054a3cc0750d23089e41f75b3_img.jpg)
...
![Eight structural isomers of C9H12 substituted benzene derivatives. The first row shows propylbenzene, isopropylbenzene, o-ethylmethylbenzene, and m-ethylmethylbenzene. The second row shows p-ethylmethylbenzene, 1,2,3-trimethylbenzene, 1,2,4-trimethylbenzene, and 1,3,5-trimethylbenzene.](images/2d49cefb0ddbb091818b6c7a20455a53_img.jpg)

⇒

Eight structural isomers of C9H12 substituted benzene derivatives. The first row shows propylbenzene, isopropylbenzene, o-ethylmethylbenzene, and m-ethylmethylbenzene. The second row shows p-ethylmethylbenzene, 1,2,3-trimethylbenzene, 1,2,4-trimethylbenzene, and 1,3,5-trimethylbenzene.